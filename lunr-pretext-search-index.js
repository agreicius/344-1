...
},
{
  ...
  "number": "1.11.11",
  "title": "Quotient by an equivalence relation.",
  "body": " Quotient by an equivalence relation  Let be a topological space, let be a surjective function, and let be the equivalence relation defined on as if and only if .  Prove: is homeomorphic to with its quotient topology.     "
},
{
  "id": "eg_quot_prod",
  "level": "2",
  ...
  "body": " Quotient of product space    be the topological product of the spaces . Fix and define the equivalence relation on as follows: given and , we have . In other words, two tuples are equivalent if their -th coordinates are equal.  Let with the quotient topology. Prove: is homeomorphic to .      "
},
{
