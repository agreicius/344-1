...
},
{
  ...
  "body": " Equivalent alternative to axiom (3)  Using induction, we can show that if satisfies axiom (3) for any two elements of , then it satisfies it for any elements, for arbitrary. In other words, we get an equivalent notion of a topological space if we replace axiom (3) with the following:   (3')  If , then      "
},
{
